...
class ONNX_OPERATOR_KERNEL_CLASS_NAME( kCpuExecutionProvider, kMSDomain, 1, SequenceConvEmbedding );
...
void RegisterContribKernels(std::function<void(KernelCreateInfo&&)> fn) {
  ...
  fn( BuildKernel<ONNX_OPERATOR_KERNEL_CLASS_NAME( kCpuExecutionProvider, kMSDomain, 1, SequenceConvEmbedding )>() );
